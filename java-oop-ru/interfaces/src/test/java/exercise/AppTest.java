...
class AppTest {
    ...
    void testReversedSequence() {
        ...
        assertThat(text1.charAt(1)).isEqualTo('e');

        CharSequence text2 = new ReversedSequence("abcdef");
        assertThat(text2.length()).isEqualTo(6);

        CharSequence text3 = new ReversedSequence("abcdef");
        assertThat(text3.subSequence(1, 4).toString()).isEqualTo("edc");
    }
    // END
}
